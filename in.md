# Fundamental Analysis for Investors - By Gopikrishna &#128526;
...
* Positive Risk - losing the profits (unrealised profits) due to some incidents and all profits vanish. Unless profit is booked it is unrealised and carry risk of losing those profits
* Negative Risk - Value lower than the acquisition price. Something bought and after that value gone down
...
### Categories of Stocks : Based on Market Cap
...
[https://www.moneycontrol.com/markets/indian-indices/](https://www.moneycontrol.com/markets/indian-indices/)

![](img/in48.png)

### Categories of Stocks : Based on their Value Proposition
...
ITC is more value stock because of its Cigarette business which brings in huge profit. But because of Govt. regulations and increase in taxes ITC always like cat on wall. So investors feel risky stock and its value is often cheap. Hence considered value stock. Also compare P/E ratio of ITC with its peers. Lesser P/E when compared to industry P/E & peers P/E means then its price is more cheap

* ITC P/E - 19.2
* Hindustan Unilever P/E - 76.5
* Nestle India P/E - 78.1
* Titan P/E - 179.93
* Industry P/E - 35.54 
...
Assume this your P/L statement and Balance Sheet. If possible put in your own real numbers and check what is the performance? If you understand this then it is easy to follow the statements of companies and predict the impact of it in their stocks.
...
The money that is generated by selling their products or services is called Income or Revenue.  
In India we follow, IND AS (Indian Accounting standard) to report financials.   
Every public company follows this standard hence it is easy for us to go through the report to compare and understand the line items with respect to every other company
...
### Expenses: Change in Inventories

Inventory - Raw material or work-in-progress product or Finished product. It can be any of these three.  
For ex. Maruti Company - Tyres in warehouse or cars under production or cars in showroom for sale. All these are Inventory

Change in Inventory is for Matching purpose.  
Matching means "Matching the Revenue with Expenses during that period"

![](img/in340.png)
![](img/in341.png)
![](img/in342.png)

When Change in Inventory is in negative, then it means "More products were produced than actually what was sold"  
When Change in Inventory is in positive, then it means "Less products were produced than actually what was sold"
...
IT Sector spends more money for its employees. Hence lavish lifestyle for IT people

![](img/in347.png)

Manufacturing sectors spends more only on its raw materials and hence spends less on employee expenses
...
This is why Cash Flow Statment is so much important. What if for the next year if he needs more than 5L to run his business then obviously he would borrow money and that would leave him with some interest expense and hence profit goes down. So this is how P/L statement can misguide Investors.   
Therefore Profit is not equal to Cash. Cash has significance in running business. If you run out of cash then business gets impact.  
**Always check Cash Flow Statement of companies you invest.**
...
Operating activities list is very long. That is the work of CA to figure out whether this is activity or not and if it is then to which type of activity it belongs to. Here we should be see the big picture. Just check the activities of the company involving core business. Let's say for example we take Maruti then activities would be
...
**Rejecting companies based on Operating Activities**

![](img/in394.png)

### Investing Activities

Don't look too much into Investing activities unless it is a very high number
...
Cash Flow Statement of Banking stocks and other companies should be analysed altogether with a different view

![](img/in403.png)

## FINANCIAL RATIOS

### Rejecting companies based on Reserves & Surplus
...
Financial ratios save us a lot of time. A lot of time is required to analyze one company so think of analyzing a hundred companies because at end of the day we are looking for the best-performing companies to invest our money and become part of the company. Hence it is a tedious process so therefore we come up with Financial ratios to at least filter out the companies. Just understand what these ratios mean and represent. Also, have some thumb rules for the thresholds beyond which the company becomes acceptable or unacceptable as an Investor.  

It is the first level of analyzing the company using financial ratios. There are many types of ratios are available but we will look into only the important ones and safely ignore which are not significant.
...
Can use [https://www.screener.in/](https://www.screener.in/) to view the ratios and also possible to create our own ratio. Very useful site for Investors
...
Compare Debt/Equity ratio of competitors or other companies in same sector. At the end of comparison if the number is high for a particular company then investigate further and think twice before investing or being part of that company
...
Operating profit comes from the core business. Net profit can sometimes may mislead you because company may get most of its profits from some other source apart from core business. So as an Investor we should invest in companies where core business is fine and most profits comes out of it.
...
### Great Business-Good Price or Good Business-Great Price

![](img/in489.png)
![](img/in490.png)
![](img/in491.png)

### The non-linear nature of market
...
Upper circuit hits - Exchanges reject sell orders  
Lower circuit hits - Exchanges reject buy orders
...
### Should I just hand it over to Mr.Bigshot?
...
### What about Rakesh Jhunjhunwala?
...
Check out how well the rest of the recommeded stocks are performing and you will come to know the fact
