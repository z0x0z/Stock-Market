...
1. Give you margins for trading – We will discuss this point at a later stage.
1. Provide support – Dealing support if you have to call and trade. Software support if you have issues with the trading terminal
...
1. Provide you with a back-office login – using which you can see the summary of your account
1. The broker charges a fee for the services he provides called the ‘brokerage charge’ or just brokerage. The brokerage rates vary, and it’s upto you to find a broker who strikes a balance between the fee he collects versus the services he provides.

### 2. Depository and Depository Participants

Before 1996 the share certificate was in paper format; however post 1996, the share certificates were converted to digital form. Converting a paper format share certificate into a digital format share certificate is called “Dematerialization” often abbreviated as DEMAT. The share certificate in DEMAT format has to be stored digitally. The storage place for the digital share certificate is the **‘DEMAT Account’**.  
A Depository is a financial intermediary which offers the service of the Demat account. A DEMAT account in your name will have all the shares in the electronic format you bought. Think of the DEMAT account as a digital vault for your shares.  
your broker’s trading account and the DEMAT account from the Depository are interlinked.  
...
Banks help in facilitating the fund transfer from your bank account to your trading account. You cannot transfer money from a bank account that is not in your name.  
You can link multiple bank accounts to your trading through which you can transfer funds and trade. At Zerodha, you can add 1 primary bank account and up to 2 secondary bank accounts. You can use all the bank accounts to add funds, but withdrawals are only processed to the primary bank account. Also, dividend payments, money from buybacks will be sent to the primary bank account.
...
Cannot trade F&O during pre-market
...
For Intraday Traders FA is not of that much important but it can give you an edge. 

![](images/fa0.png)
![](images/fa1.png)
![](images/fa2.png)

**Swing traders look at Quarterly statements. Only Investors look at Annual Statements**

**Best Sources for Fundamental Analysis**
...
**8 Questions to ask any company during Fundamental Analysis**

1. Revenue Growth - Sales info (Quarterly results)   
1. Net Profit Growing  - Profit after tax info (Quarterly results)  
1. Main Competitors  - If competitors are strong then its bad  
1. How is the DEBT situation - low debt then good position  
1. Trend in Promotor holding  - If Promotor's stake is less then its bad  
1. Trend in Mutual fund holding  - More holding more good
1. Industry Growth - Whether the whole sector is growing (For ex. After JIO entry it almost killed many companies. Even though JIO grows but the whole sector performance goes down)  
1. Government Regulation - Government over regulates companies hence it is negative in stock market. (For ex. SBI bank)
...
Industry is broad perspective whereas sector is part of it.  
For ex. Automobile is an Industry and MRF tyres, tata motors are sectors of it.  
Every sector has a Lion, Lamb, Tiger.  
For ex. HDFC bank is lion in private sector bank. who hold majority of market. YES bank is Lamb because it is weak company in sector. Tiger is fast growing company in same sector i,e. ICICI bank

Start thinking like "Industry/Sector" (in industry which sector what company) you would like to invest  
Check about industry here, go through industry reports    
...
Check all stats here,  
[https://www.moneycontrol.com/stocks/marketstats/index.php](https://www.moneycontrol.com/stocks/marketstats/index.php)

![](images/fa10.png)

#### Steps for Fundamental Analysis

* First, Google about the company and understand what the company does  
* Find what is core products or services of that company and what % level of market they possess  
* Understand who are their competitors and how well they perform  
* Is the whole Sector & Industry performing good or bad, whats the current and future state will be  
* Is it part of small, mid or large cap. Is it part of Index? If so what is the weightage?  
* Check P/E ratio and compare it with sectoral P/E ratio to decide what investors think about company  
* Ask the above 8 questions to the company  
* Check the performance of the Stock, check daily, weekly, monthly charts. Technical Analyse how well the equity market is?     
...
#### What does a trader look for in an IPO

1. **Listing Gains -** That is after subscribing to IPO and when shares are allocated to trader (for ex. at 100rs) and on the day that stock gets lists on the exchange (for ex. at 120rs) how much listing gains is possible (in this case it is 20%) [chance of loss also can happen]  
2. **Trading Opportunities -** If the stock price goes up than the price which the trader got shares alloted then it is profit. Have to check for overall market sentiment towards that stock. 


#### Steps to do as a Trader

* Information Gathering - Know as much as info about the company  
* Get Red Herring Prospectus - All info about IPO is there  
* Get Promotor information - check his credibility and history  
* Check other company info by same Promotor - If promotor promotes other companies, what is his role & how well is it  
* What does the company do - Dig little deeper to find what all company does & their source of revenue  
* Industry info - Which Industry & Sector the company belongs to and who are all its competitors for their core business  
* Competitor info - Are the competitors listed and their performance in the market  
...
Have to do Fundamental Analysis. As the company is not listed so far hence no technical analysis

It is good if company is analysed based on below points,
...
### Intraday Plan for IPO

**Only take handpicked selected & very much promising stocks for Listing Gains**

**Select stocks based on below criteria,**
...
### Swing Trade Plan for IPO

* Less stress and high gain percentage.  
* Only on long side  
* cannot short.  
* Patience is key.  
* Overnight risk is there.  
* Take Hedge position in Options
...
Up until late 1990s only Forward contracts were there and no F&O. Even till date Forward contract exists but only for banks, businesses & big institutions. Agreement b/w 2 parties buyers and sellers. there is no 3rd party involved.  
Over the counter - that is no automation, have to talk, decide and buy contract only on physical presence

![](images/fu0.png)
![](images/fu1.png)

For ex. Buyer wants to buy gold after 3 months at 1500$. If seller agrees then contract is drawn b/w parties. Seller charges some money as premium basically fees which doesn't matter. Buyer's intention price will go up. Seller's intention price will fall down. Either one will be profitable. Both of them are liable i.e. should obey the contract.
...
NSE introduced Futures in Indian stock market. Very similar concept like Forward contracts but eliminates all negative risks. Buyers have positive view of price will go up and Sellers have negative view of price will go down. 3rd party involved that is the stock exchange.   
Derivates are instruments whose price is derived from its underlying asset.  
For ex. NIFTY MAR FUT price is derived from NIFTY 
...
### Core Concept - Lot Size & Contract value
...
### Intraday vs Delivery in Futures
...
Not much important for Intraday trading. But if position is carried overnight then very much necessary to understand how the Futures price is calculated.
...
At the time of expiry, spot price and future price converge i.e. it'll be almost same. Because the time factor is 0. No more time left for future contract so the price is same as spot price 

![](images/fu43.png)
![](images/fu44.png)

### Liquidity in Future Contracts

![](images/fu46.png)

### Scripts For Futures Trading

If a company is on Futures then it would definitely be on Options. there wont be case like a company is in Options but not on Futures.   
Only Large cap stocks are selected for F&O. May be high end mid cap stocks at sometimes.

![](images/fu47.png)
![](images/fu48.png)
![](images/fu49.png)

Check this link for current stocks in F&O segment,  
[https://www.nseindia.com/products-services/equity-derivatives-list-underlyings-information](https://www.nseindia.com/products-services/equity-derivatives-list-underlyings-information)

![](images/fu50.png)

### Buying and Selling Futures

Futures Delivery has overnight risk hence Hedging must be done. Stoploss order is only for Intraday & not for delivery based trades

![](images/fu51.png)
![](images/fu52.png)

### What happens when we buy a contract?

Happens Behind the Scenes. When we hit Buy or Sell button this process occurs
...
Excess money given by Broker to take trade is called leverage.  
For Intraday leverage, check below link   
[https://zerodha.com/marketintel/bulletin/249809/latest-intraday-leverages-mis-bo-co](https://zerodha.com/marketintel/bulletin/249809/latest-intraday-leverages-mis-bo-co)
...
For carrying overnight position span + exposure margin is minimum required in your trading account. If you have already taken delivery then everyday you should check & maintain total (span + exposure) margin balance in your account, orelse position will be squared off. Also margin penalty will occur
...
### M2M & daily Adjustments

Everyday after daily settlements, broker checks whether you have required total margin to carry the position orelse position is squared off. Margin penalty may occur failing to maintain minimum margin.   
Daily settlements - Profits or Losses are settled on your account everyday. this is done to avoid risk of default
...
Margin call - Minimum margin to be maintained in trading account to carry the position.   
Minimum margin = SPAN + EXPOSURE

![](images/fu78.png)
![](images/fu79.png)

### Settlement Process – Stocks & Index

Settlement process is only for those who people allowed the contract to sit in their account and let in expiry. i.e. on last thursday of Month. Never do it like that. Always square off position before one day of expiry
...
### Nifty Trading in Futures

The most important Future contract in Indian Stock Market.

![](images/fu84.png)
![](images/fu85.png)

### Bank Nifty Trading in Futures

The second most important Future contract in Indian Stock Market.
...
This is the the the the the most important for Futures Swing Trader. Never carry a Future overnight position without hedging.   
***Never carry Naked Futures position***  
If you have long position in Futures, then buy PUT option.  
If you have short position in Futures, then buy CALL option.  

Check this link to build strategy,  
...
If a Future is trading at significant discount price lets's say 5%,10% or 15% then beaware, do not trade it. It could turn volatile. But still if you want to trade then do it Cash segment.
...
### Arbitrage – Cash & Futures

Arbitrage trading can only be done in Stocks not in Index. Because stocks have both cash and Futures market whereas NIFTY and BANKNIFTY has only Futures not cash segment
...
Check F&O ban list here,  
[https://www1.niftytrader.in/ban-list](https://www1.niftytrader.in/ban-list)

![](images/fu127.png)

### Futures vs Cash - Where Should You Trade?
...
### Mistakes while trading in Futures
